...
const MainPage = () => {
  ...
  return(
    <React.Fragment>
      <section className="home-banner-section container-fluid" style={{ backgroundImage: "url(/MainPage/Banner_2.png)" }}>
          ...
          <div className="container pt-5">
            <div className="row pb-5">
              <div className="col-12 text-center">
                <p className="fs-1 text-coffee">¡Tú puedes hacer la diferencia!</p>
                <div className="d-flex justify-content-center">
                  <div className="border-top border-coffee border-4 text-white">aaaaaaa</div>
                </div>
              </div>
            </div>
            <div className="row pb-5">
      ...
      <section className="como-ayudamos-section" style={{ backgroundImage: "url(/paw_wallpaper.jpg)" }}>
          ...
          <div className="container pt-5">
            <div className="row pb-5">
              <div className="col-12 text-center">
                ...
                <div className="d-flex justify-content-center">
                  <div className="border-top border-coffee border-4 text-gray">aaaaaaa</div>
                </div>
              </div>
            </div>
            <div className="row">
