    ...
    return (
      <React.Fragment>
        <section id="quienes-somos" style={{ backgroundImage: "url(/paw_wallpaper_bw.jpg)" }}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff5ee" d="M0,160L60,144C120,128,240,96,360,106.7C480,117,600,171,720,176C840,181,960,139,1080,117.3C1200,96,1320,96,1380,96L1440,96L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
        </section>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md text-center">
                ...
                <ul className="text-start mx-4 no-bullets" id="que-hacemos-list">
                  <li><FontAwesomeIcon icon={faCheckCircle} color="orange"/>{spaces6}Alimentamos a la fauna urbana de ESPOL</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="orange"/>{spaces6}Protegemos a los más indefensos del campus</li>
                  <li><FontAwesomeIcon icon={faCheckCircle} color="orange"/>{spaces6}Buscamos un hogar digno para ellos</li>
                </ul>
              </div>
              ...
              <div className="row">
                <div className="col-lg-4 mb-4">
                  <div className="card text-center h-100 bg-transparent border-none">
                    <img src="/QuienesSomos/Gato_2.jpg" className="card-img-top" alt="..."></img>
